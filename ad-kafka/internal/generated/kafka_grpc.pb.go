...
type KafkaServiceClient interface {
	KafkaSend(ctx context.Context, in *KafkaRequest, opts ...grpc.CallOption) (*KafkaResponse, error)
}
...
func (c *kafkaServiceClient) KafkaSend(ctx context.Context, in *KafkaRequest, opts ...grpc.CallOption) (*KafkaResponse, error) {
...
type KafkaServiceServer interface {
	KafkaSend(context.Context, *KafkaRequest) (*KafkaResponse, error)
...
func (UnimplementedKafkaServiceServer) KafkaSend(context.Context, *KafkaRequest) (*KafkaResponse, error) {
...
func _KafkaService_KafkaSend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KafkaServiceServer).KafkaSend(ctx, req.(*KafkaRequest))
	}
